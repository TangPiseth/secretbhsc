...
-- Settings for auto spam and other features
local AutoSpam, SpamText, SpamDelay = false, "Your spam text here", 5000
local activeBlinkskin = false
local lastSpamTime, lastBlinkTime = 0, 0
local spamPaused, blinkPaused = false, false

-- Emoji database for chat features
local emoji = {
...
function showBalance()
  datalock = {} 
  wl_balance = sharksid(242) 
  dl_balance = math.floor(sharksid(1796)) 
  bgl_balance = math.floor(sharksid(7188)) 
  black_balance = math.floor(sharksid(11550)) 
  total_balance = wl_balance + (dl_balance * 100) + (bgl_balance * 10000) + (black_balance * 1000000)
  
  sharklog("`9Locks Balance: `#"..total_balance.." `9World Lock")
end
...
function sharklog(text)
  LogToConsole("`w[`^icShark`w] `9"..text)
end

function overlayText(text)
  var = {}
  var[0] = "OnTextOverlay"
  var[1] = "`w[`^icShark`w] `9".. text
  SendVariantList(var)
end
...
add_label_with_icon|big|`0Reme/Qeme `0- `2Helper |left|758|
add_textbox|`2--------------------------------------------------------```|
add_smalltext|`0Proxy Created By `b@icShark|
add_smalltext|`0Contact Via Discord `b@showtime_red|
add_textbox|`2--------------------------------------------------------```|
add_label_with_icon|small|`0Greetings ]]..GetLocal().name..[[|right|9474|
add_label_with_icon|small|`0You're currently in `9]]..GetWorld().name..[[|left|3802|
add_label_with_icon|small|`0Your position is X : `1]]..math.floor(GetLocal().pos.x / 32)..[[, `0Y : `1]]..math.floor(GetLocal().pos.y / 32)..[[|left|4922|
add_textbox|`2--------------------------------------------------------```|
add_label_with_icon|small|`0Features :|left|11304|
add_spacer|small|
...
add_button_with_icon|spam_menu|`0Spam Menu|staticBlueFrame|1596||
add_custom_break|
end_list|
add_button_with_icon|chatting_menu|`0Chat Menu|staticBlueFrame|8282||
add_button_with_icon|skin_menu|`0Skin Selection|staticBlueFrame|6214||
add_button_with_icon|cctv_menu|`0World Logs|staticBlueFrame|1436||
add_button_with_icon|command_proxyinfo|`0Creator Info|staticBlueFrame|2376||
...
add_label_with_icon|small|`2/cd <amount> `0: custom drop locks [/cd 1150 (means 11dl 50wl)]|left|482|
add_label_with_icon|small|`2/dw <amount> `0: drop `9World Lock|left|482|
add_label_with_icon|small|`2/dd <amount> `0: drop `1Diamond Lock|left|482|
add_label_with_icon|small|`2/db <amount> `0: drop `eBlue Gem Lock|left|482|
add_label_with_icon|small|`2/di <amount> `0: drop `bBlack Gem Lock|left|482|
add_label_with_icon|small|`2/wall `0: drop all `9World Lock|left|482|
add_label_with_icon|small|`2/dall `0: drop all `1Diamond Lock|left|482|
add_label_with_icon|small|`2/ball `0: drop all `eBlue Gem Lock|left|482|
add_label_with_icon|small|`2/bball `0: drop all `bBlack Gem Lock|left|482|
add_spacer|small|
add_label_with_icon|small|`0Custom Convert|left|3898|
add_label_with_icon|small|`2/dml `0: convert `eBlue Gem Lock `0to `1diamond lock|left|482|
add_label_with_icon|small|`2/bla `0: convert `eBlue Gem Lock `0to `bBlack Gem Lock|left|482|
add_label_with_icon|small|`2/blu `0: convert `bBlack Gem Lock `0to `eBlue Gem Lock|left|482|
add_label_with_icon|small|`2/cbgl `0: wrench for convert dl > bgl|left|482|
add_label_with_icon|small|`2/fbgl `0: fast convert dl > bgl|left|482|
add_label_with_icon|small|`2/buymega `0: fast buy megaphone|left|482|
add_label_with_icon|small|`2/buycham `0: fast buy champagne|left|482|
add_spacer|small|
add_label_with_icon|small|`0Custom Bank|left|1008|
add_label_with_icon|small|`2/dp <amount> `0: deposit your bgl to bank|left|482|
add_label_with_icon|small|`2/wd <amount> `0: withdraw your bgl from bank|left|482|
add_spacer|small|
add_label_with_icon|small|`0Custom Menu|left|2918|
add_label_with_icon|small|`2/warp <world name> `0 : warp to other world|left|482|
add_label_with_icon|small|`2/rc `0: reconnect|left|482|
add_label_with_icon|small|`2/re `0: rejoin world|left|482|
add_label_with_icon|small|`2/res `0: fast respawn|left|482|
add_label_with_icon|small|`2/g `0: fast ghost|left|482|
add_label_with_icon|small|`2/b `0: back to world before|left|482|
add_label_with_icon|small|`2/gs `0: show growscan|left|482|
add_spacer|small|
add_label_with_icon|small|`0Command Reme/Qeme|left|758|
add_label_with_icon|small|`2/reme `0: turn on reme number|left|482|
add_label_with_icon|small|`2/qeme `0: turn on qeme number|left|482|
add_label_with_icon|small|`2/normal `0: turn back normal roullete mode|left|482|
add_textbox|`0------------------------------------------------------|
add_quick_exit||
...
end_dialog|cheats||Apply Cheats!|
  ...
  local function ShowProxyDialog()
    ...
    varlist_command[1] = [[
set_default_color|`o
add_label_with_icon|big|`0Creator Info|left|9222|
add_custom_break|
add_textbox|`0------------------------------------------------------|
add_smalltext|`0Script Creator|left|
add_spacer|small|
add_label_with_icon|small|`5icShark|left|5956|
add_textbox|`0------------------------------------------------------|
add_quick_exit||
add_button|command_back|`9Back|noflags|0|0|
]]
...
add_label_with_icon|small|`2/wpl `0: auto pull|left|482|
add_label_with_icon|small|`2/wkk `0: auto kick|left|482|
add_label_with_icon|small|`2/wban `0: auto ban|left|482|
add_spacer|small|
...
add_text_input|blue|`1Blue    :|]]..blues..[[|5|
...
end_dialog|skinpicker|     Close     |     `wSave     |
  ...
  local function ShowSpamDialog()
    ...
    varlist_command[1] = [[
set_default_color|`o
add_label_with_icon|big|Setting Auto Spam|left|7670|
add_spacer|small|
...
add_button|command_back|`9Back|noflags|0|0|
  ...
  local function ShowChangeDialog()
    ...
    varlist_command[1] = [[
set_default_color|`o
add_label_with_icon|big|`wReme/Qeme Helper |left|]] .. 758 ..[[|
add_spacer|small||
add_label_with_icon|small|`wHello Thanks For Using This Script ]]..GetLocal().name..[[|left|386|
add_spacer|small||
add_label_with_icon|big|`0About Script|left|528|
add_spacer|small|
add_smalltext|`9Script Coded/Tested by icShark|
add_smalltext|`9Full Premium Version|
add_url_button|icShark|`eContact|noflags|https://icShark.com|Contact icShark here|0|0|
add_quick_exit||
add_button|command_back|`9Back|noflags|0|0|
]]
    SendVariantList(varlist_command)
...
add_button|back_cctv_menu|`9Back|noflags|0|0|
  ...
  local function ActivityLogDrop()
    ...
    varlist_command[1] = [[
set_default_color|`o
add_label_with_icon|big|Logs Dropped Locks|left|13808|
add_spacer|small|
...
add_button|back_cctv_menu|`9Back|noflags|0|0|
    ...
    while AutoSpam do
      ...
      if GetWorld() == nil then
        if not isPaused then
          sharklog("Auto Spam `4Paused `w(Not in world)")
          isPaused = true
        end
      else
        if isPaused then
          sharklog("Auto Spam `2Resumed")
          isPaused = false
        end
      end
  ...
  local function blinkLoop()
    ...
    while activeBlinkskin do
      ...
      if GetWorld() == nil then
        if not isPaused then
          sharklog("Blink Mode `4Paused `w(Not in world)")
          isPaused = true
        end
      else
        if isPaused then
          sharklog("Blink Mode `2Resumed")
          isPaused = false
        end
  ...
  -- Chat Hook for emoji and colored chat
  ...
  -- Supporting hooks for blinkskin
...
local function hook_1(varlist)
  if varlist[0]:find("OnConsoleMessage") then
      ...
      elseif varlist[1]:find("Unknown command.") then
        sharklog("`4Unknown command. `9Enter /menu or click social portal for valid list commands.")
          return true
      end
  end
...
local function cvhook(varlist)
  if varlist[0] == "OnConsoleMessage" and varlist[1]:find("(%d+) Diamond Lock") and CONFIG.AUTO_CHANGE_BGL then
      ...
      if current_dl >= 100 then
          ...
          if not found_telephone then
              sharklog("`w[`4Oops`w] `9No telephone in world. Please place a telephone down to use this feature.")
              return
          end
  ...
  if varlist[0]:find("OnDialogRequest") and varlist[1]:find("`wTelephone") then
      ...
      if CONFIG.FAST_CHANGE_BGL then
          if sharksid(1796) < 100 then
              sharklog("`w[`4Oops`w] `9You don't have `c100 Diamond Lock `9to Convert")
              return true
          end
          SendPacket(2, "action|dialog_return\ndialog_name|telephone\nnum|53785|\nx|"..TELEPHONE_X.."|\ny|"..TELEPHONE_Y.."|\nbuttonClicked|bglconvert")
          return true
...
AddHook("onvariant", "join_world", function(var)
  ...
  if var[0]:find("OnConsoleMessage") and var[1]:find("Moving to the last location") then
    sharklog("Moving back to last location")
    return true
  end
end)
...
local function add_drop_log(amount, item_name, color)
    ...
    local log_entry = {
        actt = string.format("\nadd_label_with_icon|small|[%s] %s `oDropped `w%d `%s%s|left|1360|\n",
                             timestamp,
                             GetLocal().name,
                             amount,
                             color,
...
local function addCollectLog(items)
    ...
    table.insert(LogsCollect, {
        act = "\nadd_label_with_icon|small|" .. logMessage .. "|left|1360|\n",
        netid = GetLocal().netID,
  ...
  if varlist[0] == "OnTalkBubble" then
      ...
      if donor and amount and item then
          ...
          table.insert(LogsDonate, {
              actd = "\nadd_label_with_icon|small|"..donor.." `oDonated `w"..AmountDonation.." `o"..item.." into the Donation Box at "..os.date("%H:%M on %d/%m").."|left|1360|\n", 
              netid = GetLocal().netID, 
...
local function GET_BALANCE()
  local WLS = sharksid(242)
  local DLS = sharksid(1796)
  local BGLS = sharksid(7188)
  local BLGLS = sharksid(11550)
...
local function drop_items(blgls, bgls, dls, wls)
  local function drop(item_id, count, item_type)
      if count > 0 then
          local current = sharksid(item_id)
          
          if current < count then
              if item_id == 242 and sharksid(1796) > 0 then
                  SendPacketRaw(false, {type = 10, value = 1796})
                  Sleep(500)
              elseif item_id == 1796 and sharksid(7188) > 0 then 
                  SendPacketRaw(false, {type = 10, value = 7188})
                  Sleep(500)
              elseif item_id == 7188 and sharksid(11550) > 0 then
...
--Fast Convert
  if str:find("/cbgl") then
    ...
    sharklog(CONFIG.FAST_CHANGE_BGL and "`2Enabled `0Fast Change BGL" or "`4Disabled `0Fast Change BGL")
    return true
  end

  if str:find("/fbgl") then
    CONFIG.AUTO_CHANGE_BGL = not CONFIG.AUTO_CHANGE_BGL
    sharklog(CONFIG.AUTO_CHANGE_BGL and "`2Enabled `0Auto Change BGL" or "`4Disabled `0Auto Change BGL")
    return true
  end
...
if str:find("/buychamp") then
  ...
  if not found_telephone then
    sharklog("`w[`4Oops`w] `wNo telephone in world. Please place a telephone down to use this feature.")
    return
  end
      ...
      if plr.netid == netid0 then
          if plr.netid == localPlayer.netid then
              if CONFIG.AUTO_PULL then
                  sharklog("`w[`4Oops`w] `9Can't pull your self sir")
                  return true
              elseif CONFIG.AUTO_KICK then
                  sharklog("`w[`4Oops`w] `9Can't kick your self sir")
                  return true
              elseif CONFIG.AUTO_BAN then
                  sharklog("`w[`4Oops`w] `9Can't ban your self sir")
                  return true
              end
          else
              if CONFIG.AUTO_PULL then
...
if str:find("/rect") then
  if str:match("/rect") then
    if not CONFIG.RANDOM_CHAT then
      ...
      sharklog("Random Emoji Chat `2Enabled")
    else
      CONFIG.RANDOM_CHAT = false
      sharklog("Random Emoji Chat `4Disabled")
    end
    return true
  end
end
...
AddHook("onsendpacket", "mypackageid", function(type, pkt)
  ...
  elseif pkt:find("/cd (%d+)") then
      ...
      if value > balance then
          sharklog("`4Error: `9Requested drop amount exceeds balance.")
          return false
      end
      ...
      RunThread(function()
          ...
          sharklog(string.format("`2Dropping Locks`w: %d `bBlack Gem Locks`w, %d `eBlue Gem Locks`w, %d `1Diamond Locks`w, and %d `9World Locks",
...
if real == true then
  showBalance()
  sharklog("Use /menu or click on friend button to open menu")
  Sleep(100)
  say("`9r/q proxy inject by `#@icShark")
  main()
end
